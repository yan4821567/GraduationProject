...
<![endif]-->
	...
	<div class="am-cf admin-main">
		...
		%>
		<form
			action="/restaurant/CustomerCtrl?action=update&id=<%=cv.getId() %>" method="post" class="am-form am-form-horizontal">
			<fieldset>
				<legend class="am-text-center">
					修改<%=cv.getId() %>号客户信息
				</legend>
				<div class="am-form-group am-g">
					<label for="doc-ipt-3" class="am-u-sm-5 am-form-label am-text-right">客户姓名</label>
					<div class="am-u-sm-5 am-right">
						<input type="text" name="name"
							class="aw-register-name am-form-field am-radius" value="<%=cv.getName()%>">
					</div>
					<div class="am-sm-end col-sm-end"></div>
				</div>
					<div class="am-form-group am-g">
					<label for="doc-ipt-3" class="am-u-sm-5 am-form-label am-text-right">客户年龄</label>
					<div class="am-u-sm-5 am-right">
						<input type="text" name="age"
							class="aw-register-name am-form-field am-radius" value="<%=cv.getAge()%>">
					</div>
					<div class="am-sm-end col-sm-end"></div>
				</div>
					<div class="am-form-group am-g">
					...
					<div class="am-u-sm-5 am-right">
						<input type="text" name="tel"
							class="aw-register-name am-form-field am-radius" value="<%=cv.getTel()%>">
					</div>
					<div class="am-sm-end col-sm-end"></div>
				</div>
				<div class="am-form-group am-g">
					...
					<div class="am-u-sm-5">
						<label class="am-radio-inline"> <input type="radio"
							value="1" name="gender" checked="<%if(cv.getGender()==1){out.print("checked");}%>"> 男 </label> <label
							class="am-radio-inline"> <input type="radio" value="0"
							name="gender" <%if(cv.getGender()==0){out.print(" checked='checked'");}%>>女 </label>
					</div>
					<div class="am-sm-end col-sm-end"></div>
				</div>
				<div class="am-form-group am-g">
					<label for="doc-ipt-3" class="am-u-sm-5 am-form-label am-text-right">客户兴趣</label>
					<div class="am-u-sm-5 am-right">
						<input type="text" name="interest"
							class="aw-register-name am-form-field am-radius" placeholder="顺序为川菜、冷饮、粤菜、甜点、日本料理、水果" value="<%=cv.getInterest()%>">
					</div>
					<div class="am-sm-end col-sm-end"></div>
				</div>
				...
				<p>
					...
					<a class="am-btn am-btn-warning am-btn-sm" href="customerlist.jsp"> <span
