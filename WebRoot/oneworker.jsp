...
<![endif]-->
	...
	<div class="am-cf admin-main">
		...
		<!-- content start -->
		<form
			action="/restaurant/WorkerCtrl?action=update&id=<%WorkerVo wv = (WorkerVo) request.getAttribute("wv");
			out.print(wv.getId());%>"
			...
			<fieldset>
				...
				<div class="am-form-group am-g">
					<label for="doc-ipt-3"
						class="am-u-sm-5 am-form-label am-text-right">员工姓名</label>
				...
				<div class="am-form-group am-g">
					<label for="doc-ipt-3"
						class="am-u-sm-5 am-form-label am-text-right">员工年龄</label>
					<div class="am-u-sm-5 am-right">
				...
				<div class="am-form-group am-g">
					<label for="doc-ipt-3"
						class="am-u-sm-5 am-form-label am-text-right">电话</label>
					<div class="am-u-sm-5 am-right">
				...
				<div class="am-form-group am-g">
					...
					<div class="am-u-sm-5">
						<label class="am-radio-inline"> <input type="radio"
							value="1" name="gender" checked="<%if(wv.getGender()==1){out.print("checked");}%>"> 男 </label> <label
							class="am-radio-inline"> <input type="radio" value="0"
							name="gender" <%if(wv.getGender()==0){out.print(" checked='checked'");}%>>女 </label>
					</div>
					<div class="am-sm-end col-sm-end"></div>
				</div>
				<div class="am-form-group am-g">
					<label for="doc-ipt-3"
						class="am-u-sm-5 am-form-label am-text-right">密码</label>
					<div class="am-u-sm-5 am-right">
						<input type="password" name="password"
							class="aw-register-name am-form-field am-radius"
							value="<%=wv.getPassword()%>">
					</div>
					<div class="am-sm-end col-sm-end"></div>
				</div>
				...
				<div class="am-form-group am-g am-text-center">
					<p>
						...
						<a class="am-btn am-btn-warning am-btn-sm" href="workerlist.jsp">
							<span class="am-icon-mail-reply "> 取消</span> </a>
					</p>
				</div>
			</fieldset>
