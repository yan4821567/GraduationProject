				...
				<table class="am-table am-table-striped am-table-hover">
					...
					<tbody>
						<%	WorkerModel wm=new WorkerModel();
							List<WorkerVo> li=wm.selectWorkers();
							Iterator<WorkerVo> it=li.iterator();
							while(it.hasNext()){
								WorkerVo wv=it.next();
						 %>
						 <tr>
						 	...
						 	<td>
						 		<a class="am-btn am-btn-default am-btn-xs"
									href="/restaurant/WorkerCtrl?action=updateshow&id=<%=wv.getId() %>"
									target="_top"><span
									class="am-icon-pencil-square-o  am-text-primary">
									更改</span>
								</a>
								<a class="am-btn am-btn-default am-btn-xs"
								    href="/restaurant/WorkerCtrl?action=delete&id=<%=wv.getId() %>"
									target="_top"><span
									class="am-icon-trash  am-text-danger">
									删除</span>
								</a>
						 	</td>
						 </tr>
