		...
		<form class="am-form">
			<fieldset>
				...
				<div class="am-form-group">
					<label for="doc-ipt-3" class="am-form-label">客户姓名</label>
						<span><%=cv.getName() %></span>
				</div>
				<div class="am-form-group">
					<label for="doc-ipt-3" class="am-form-label">饮食偏好</label>
						<span><%=cv.getInterest()%> (顺序为川菜、冷饮、粤菜、甜点、日本料理、水果)</span>
				</div>
				<div class="am-form-group">
					<label for="doc-ipt-3" class="am-form-label">推荐区域</label>
						<span><%
								if(area==1){
									out.print("A区");	
								}else if(area==2){
				...
				<p>
					<a class="am-btn am-btn-success am-btn-sm"
							href="index.jsp">
							<span class="am-icon-check "> 选座</span>
					</a>
