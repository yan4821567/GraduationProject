...
<![endif]-->
	...
	<div class="am-cf admin-main">
		...
		<!-- content start -->
		<form
			action="/restaurant/CustomerCtrl?action=insert" method="post" class="am-form am-form-horizontal">
			<fieldset>
				...
				<div class="am-form-group am-g">
					...
					<div class="am-u-sm-5 am-right">
						<input type="text" name="interest"
							class="aw-register-name am-form-field am-radius" placeholder="顺序为川菜、冷饮、粤菜、甜点、日本料理、水果">
					</div>
					<div class="am-sm-end col-sm-end"></div>
				</div>
